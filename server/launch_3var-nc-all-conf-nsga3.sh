...
do  
    ...
    sbatch --job-name "$JOB_NAME" "$SRC_DIR"/experiment.job 3var-noncausal 2000 100 $CONFIDENCE 300 "$RUNS_RESULTS_DIR" 3 --NGEN 300 --POP_SIZE 150 --n_digits 1 --nr_refits 5 --predict_individualized True --parallelise --genetic_algo nsga3
done